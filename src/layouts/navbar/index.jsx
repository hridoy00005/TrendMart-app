...
const Navbar = () => {
  const authenticate = true;//authenticate control
  return (
    <nav className="hidden sm:flex justify-between w-full h-full bg-sky-950 px-5 text-white mb-2">
      ...
      <div className="flex gap-3 my-auto">
        <img src={cart} alt="" className="w-8 bg-slate-300 rounded-lg" />
        {authenticate ? (
          <Account />
        ) : (
          <div className="my-auto hover:bg-slate-300 hover:text-black rounded-lg p-1">
